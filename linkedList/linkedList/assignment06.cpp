...
void testSimple()
{
   ...
   try
   {
      ...
      cout << "Create a bool linked list\n";
       custom::Node <bool> * n1 = new custom::Node <bool> (true);
       n1->pNext = new custom::Node <bool> (false);
      n1->pNext->pPrev = n1;
      ...
      cout << "Create a double linked list and add two elements: 1.1 2.2\n";
       custom::Node <double> * n2 = new custom :: Node <double> (1.1);
      n2->pNext = new custom :: Node <double> (2.2);
      n2->pNext->pPrev = n2;
...
void testInteractive()
{
   ...
   custom :: Node <string> * p;    // loop variable through the list
      ...
      try
      {
         switch (command)
         {
            ...
            case '?':
               ...
               // find the node
               p = find(n, text); //should pass in a Node object and a value
...
void testRemove()
{
   ...
   {
      // fill the array
      custom :: Node <string> * p = new custom :: Node <string> (string("Dog"));
